...
function [coeff_zernicke,Surf_poly]=zern(phi,affichage_surface)
...
for i=2:N
    M(:,i-1)=calc_zer(Pts_pol,i);
end


%Calcul des coefficients de la base 
coeff_zernicke=M\phi ;
coeff_zernicke =[0;coeff_zernicke];
coeff_zernicke (coeff_zernicke <1e-3)=0; %pas significatifs
