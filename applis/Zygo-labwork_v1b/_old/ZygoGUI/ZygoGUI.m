...
% Last Modified by GUIDE v2.5 18-Jul-2014 11:39:44
...
ax1=subplot(2,3,1,'Position',[0.05 0.6 0.3 0.4]);imshow(uint8(img1));xlabel('Premier interferogramme')
ax2=subplot(2,3,2,'Position',[0.36 0.6 0.3 0.4]);imshow(uint8(img2));xlabel('Déphasage de 90°')
ax3=subplot(2,3,3,'Position',[0.67 0.6 0.3 0.4]);imshow(uint8(img3));xlabel('Déphasage de 180°')
ax4=subplot(2,3,4,'Position',[0.05 0.1 0.3 0.4]);imshow(uint8(img4));xlabel('Déphasage de 270°')
ax5=subplot(2,3,5,'Position',[0.36 0.1 0.3 0.4]);imshow(uint8(img5));xlabel('Déphasage de 360°')
ax6=subplot(2,3,6,'Position',[0.67 0.1 0.3 0.4]);imshow(uint8(img_moyenne));xlabel('moyenne de 4 images')
linkaxes([ax6 ax5 ax4 ax3 ax2 ax1], 'xy');
