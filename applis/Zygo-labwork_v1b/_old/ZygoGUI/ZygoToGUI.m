function varargout = ZygoGUI(varargin)

% Last Modified by GUIDE v2.5 29-May-2015 11:25:47
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @ZygoGUI_OpeningFcn, ...
    'gui_OutputFcn',  @ZygoGUI_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
%--------------------------------------------------------------------------
function ZygoGUI_OpeningFcn(hObject, eventdata, handles, varargin)
global o;
o=0;
% Choose default command line output for ZygoGUI
...
% Update handles structure
guidata(hObject, handles);
% --- Executes just before ZygoGUI is made visible.
...
function varargout = ZygoGUI_OutputFcn(hObject, eventdata, handles)
...
switch (o)
    case (0)
handles.h=actxcontrol('UEYECAM.uEyeCamCtrl.1','position',[300 340 235 235]); % on crée l'objet pour la caméra
handles.h.InitCamera(0);
