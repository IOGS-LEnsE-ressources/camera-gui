...
class MiniCameraWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.camera_params_widget = CameraParamsView()
...
class MainView(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.mini_camera = MiniCameraWidget()
        self.layout.addWidget(self.mini_camera, 0, 0)
        self.acquisition_options = AcquisitionView()
        self.layout.addWidget(self.acquisition_options, 1, 0)
        self.motors_options = MotorControlView()
