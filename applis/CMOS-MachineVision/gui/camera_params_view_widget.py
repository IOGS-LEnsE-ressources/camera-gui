...
class CameraParamsViewWidget(QWidget):
    def __init__(self, parent):
        ...
        # --------
        # Temperature sensors are not implemented in old versions of camera
        self.subwidget_temperature = QWidget()
        self.sublayout_temperature = QHBoxLayout()
        self.label_title_temperature = QLabel(translate("label_title_temperature"))
        self.label_title_temperature.setStyleSheet(styleH2)
        self.label_value_temperature = QLabel('Not Implemented')
        self.label_value_temperature.setStyleSheet(styleH3)
        self.sublayout_temperature.addWidget(self.label_title_temperature)
        self.sublayout_temperature.addStretch()
        self.sublayout_temperature.addWidget(self.label_value_temperature)
        self.sublayout_temperature.setContentsMargins(0, 0, 0, 0)
        self.subwidget_temperature.setLayout(self.sublayout_temperature)
        ...
        #self.layout.addWidget(self.subwidget_temperature)
    ...
    def update_parameters(self):
        if self.parent.camera is not None:
            ...
            self.label_frame_rate_max_value.setText(f'{max_fps} FPS2')
        else:
            self.label_value_camera_name.setText('No Camera')
            self.label_value_camera_id.setText('No Camera')
            self.slider_clock_freq.set_enabled(False)
