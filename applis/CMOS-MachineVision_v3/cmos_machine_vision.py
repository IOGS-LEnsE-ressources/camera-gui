...
from gui.preprocessing_widget import PreprocSubMenuWidget, ContrastWidget
...
class MainWindow(QMainWindow):
    ...
    def options_display(self):
        ...
        if self.mode == Modes.SETTINGS:
            ...
            if self.sub_mode == SubModes.PREPROC_CONTRAST:
                self.bot_center_widget = ContrastWidget(self)
                #self.submenu_layout.addWidget(self.bot_center_widget, 0, 1)
                print('PRE CONTRAST')
        elif self.mode == Modes.FILTER:
            pass
