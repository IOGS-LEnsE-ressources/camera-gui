function [spot,origine,angles,f] = spot_diagram3(phi,N,f,p)
...
spot = origines + [(f-origines(:,3)) (f-origines(:,3)) (f-origines(:,3))].* angles ; 
spot_diagram_slider('origines',origines,'angles',angles,'N',N,'f',f,'r',r) ;
...
rho = 0 ;
rho_airy = 1.22*lambda*N ;%en microns
...
%Affichage
figure('name','spot diagramme : energie encerclée','Position',[50,20,500,500]) ; 
