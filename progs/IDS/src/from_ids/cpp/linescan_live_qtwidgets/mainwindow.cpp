...
void MainWindow::init(bool backendStarted)
{
    if (backendStarted == true)
    {
        ...
        // MainWindow class
        connect(m_backEnd, &BackEnd::counterChanged, this, &MainWindow::updateStatusBar);
...
void MainWindow::createStatusBar()
{
    ...
    m_labelInfo->setText("Frames acquired: 0, errors: 0, Framerate: -, Linerate: -");
...
{
    QString strText;
	strText = QString("Frames acquired: %1, ").arg(frameCounter);
